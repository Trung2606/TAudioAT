...
playPhoto = PhotoImage(file="image/icons8-play-30.png")
playBtn = ttk.Button(middleframe, image=playPhoto, command=play_music)
playBtn.grid(row=0, column=0, padx=10)

stopPhoto = PhotoImage(file="image/icons8-stop-30.png")
stopBtn = ttk.Button(middleframe, image=stopPhoto, command=stop_music)
stopBtn.grid(row=0, column=1, padx=10)

pausePhoto = PhotoImage(file="image/icons8-pause-button-30.png")
...
rewindPhoto = PhotoImage(file="image/icons8-rewind-30.png")
rewindBtn = ttk.Button(bottomframe, image=rewindPhoto, command=rewind_music)
rewindBtn.grid(row=0, column=0)

mutePhoto = PhotoImage(file="image/icons8-mute-30.png")
volumePhoto = PhotoImage(file="image/icons8-audio-30.png")
